...
--
-- Name: games fk_winners_id; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT fk_winners_id FOREIGN KEY (winner_id) REFERENCES public.teams(team_id);
